...
ESPHome 2026.7.0 or later (the `image:` component uses the new `platform: file` form introduced in 2026.7.0). For SVG image support (required by solar/tides modules):
